...
namespace aks\ColumnSortable;

use aks\ColumnSortable\Exceptions\ColumnSortableException;
use Illuminate\Contracts\Support\Htmlable;
use Illuminate\Support\Str;

/**
 * Class SortableLink
 * @package aks\ColumnSortable
 */
class SortableLink
{
     ...
     *
     * @return string
     * @throws \aks\ColumnSortable\Exceptions\ColumnSortableException
     */
